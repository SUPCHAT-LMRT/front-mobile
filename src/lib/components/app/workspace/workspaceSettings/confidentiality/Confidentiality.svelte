<script lang="ts">
	...
	import { updateTypeWorkspace, WorkspaceType, type Workspace } from '$lib/api/workspace/workspace';
	...
	let workspaceType: WorkspaceType = $derived(workspace.type);
	...
	const handleSave = async () => {
		try {
			await updateTypeWorkspace(workspace.id, workspaceType);
			...
			<div class="flex">
				...
				<div class="ml-3">
					...
					<div class="mt-2 text-sm text-red-700 dark:text-red-400">
						<p>
							Vous n'avez pas les permissions nécessaires pour modifier la confidentialité de cet
							espace de travail.
							<br />
