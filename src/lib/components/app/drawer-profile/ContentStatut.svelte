...
<div class="space-y-6 px-2">
	<div class="flex justify-between items-center">
		<h2 class="text-xl font-semibold text-gray-700 dark:text-gray-300">Gestion des invitations</h2>
	</div>

	<Button
		variant="option" size="sm" class="text-gray-800 justify-start dark:text-gray-200"
