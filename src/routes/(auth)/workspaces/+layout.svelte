					...
					{#if workspace}
						{#key workspace}
							<Avatar.Root class="size-12 rounded-3xl bg-gray-200">
								...
								/>
								<Avatar.Fallback
									class="rounded-3xl transition-all hover:rounded-2xl hover:scale-105 bg-gray-200 dark:bg-gray-700 text-gray-700 text-sm flex items-center justify-center"
								>
